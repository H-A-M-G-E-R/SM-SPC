...
* `python repoint.py nspc music.nspc music_repointed.nspc --version=2 --p_spcEngine=315 --p_sharedTrackers=225C --p_instrumentTable=26E0 --p_sampleTable=2800 --p_sampleData=2900 --p_extra=E0`
