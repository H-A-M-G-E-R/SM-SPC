...
* `python repoint.py nspc music.nspc music_repointed.nspc --version=2 --p_spcEngine=349 --p_sharedTrackers=26DD --p_instrumentTable=2B04 --p_sampleTable=2C00 --p_sampleData=2D00 --p_extra=E0`
