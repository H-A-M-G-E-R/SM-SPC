...
* `python repoint.py nspc music.nspc music_repointed.nspc --version=2 --p_spcEngine=2E8 --p_sharedTrackers=21D4 --p_instrumentTable=26E0 --p_sampleTable=2800 --p_sampleData=2900 --p_extra=E0`
